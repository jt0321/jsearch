...
1. **Collectors**: Python workers pull data from multiple APIs: RemoteOK, Adzuna, Jobicy, and JSearch (via RapidAPI).
...
## Project Structure
- `src/collectors`: API collectors for RemoteOK, Adzuna, Jobicy, and JSearch
