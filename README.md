...
This repository contains JSearch: a real-time data engineering pipeline that collects job postings from public APIs (RemoteOK, Adzuna, Jobicy, The Muse, JSearch via RapidAPI), normalizes them, and streams them for downstream analytics.

## Architecture
![Workflow](./workflow.png)

1. **Collectors**: Python workers pull data from multiple APIs: RemoteOK, Adzuna, Jobicy, The Muse, and JSearch (via RapidAPI).
...
## Project Structure
- `src/collectors`: API collectors for RemoteOK, Adzuna, Jobicy, The Muse, and JSearch
